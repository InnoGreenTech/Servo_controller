...
void check_message(){
        ...
        else if  (label=="S1A"){servos[SERVO_1][ACC]=valeur;EEPROM.write(ACC,valeur);Serial.println(succes);}
        else if  (label=="S1P"){if(valeur==0){bitClear(analog_servo,0);pinMode(CONTROL_SERVO_1,INPUT_PULLUP);}
        else{bitSet(analog_servo,0);}EEPROM.write(30,analog_servo);Serial.println(succes);pinMode(CONTROL_SERVO_1,INPUT);}
        ...
        else if  (label=="S2A"){servos[SERVO_2][ACC]=valeur;EEPROM.write(ACC+5,valeur);Serial.println(succes);}
        else if  (label=="S2P"){if(valeur==0){bitClear(analog_servo,1);pinMode(CONTROL_SERVO_2,INPUT_PULLUP);}
        else{bitSet(analog_servo,1);}EEPROM.write(30,analog_servo);Serial.println(succes);pinMode(CONTROL_SERVO_2,INPUT);}
        ...
        else if  (label=="S3A"){servos[SERVO_3][ACC]=valeur;EEPROM.write(ACC+10,valeur);Serial.println(succes);}
        else if  (label=="S3P"){if(valeur==0){bitClear(analog_servo,2);pinMode(CONTROL_SERVO_3,INPUT_PULLUP);}
        else{bitSet(analog_servo,2);}EEPROM.write(30,analog_servo);Serial.println(succes);pinMode(CONTROL_SERVO_3,INPUT);}
        ...
        else if  (label=="S4A"){servos[SERVO_4][ACC]=valeur;EEPROM.write(ACC+15,valeur);Serial.println(succes);}
        else if  (label=="S4P"){if(valeur==0){bitClear(analog_servo,3);pinMode(CONTROL_SERVO_4,INPUT_PULLUP);}
        else{bitSet(analog_servo,3);}EEPROM.write(30,analog_servo);Serial.println(succes);pinMode(CONTROL_SERVO_4,INPUT);}
        ...
        else if  (label=="S5A"){servos[SERVO_5][ACC]=valeur;EEPROM.write(ACC+20,valeur);Serial.println(succes);}
        else if  (label=="S5P"){if(valeur==0){bitClear(analog_servo,4);pinMode(CONTROL_SERVO_5,INPUT_PULLUP);}
        else{bitSet(analog_servo,4);}EEPROM.write(30,analog_servo);Serial.println(succes);pinMode(CONTROL_SERVO_5,INPUT);}  
        ...
        else if  (label=="S6A"){servos[SERVO_6][ACC]=valeur;EEPROM.write(ACC+25,valeur);Serial.println(succes);}
        else if  (label=="S6P"){if(valeur==0){bitClear(analog_servo,5);pinMode(CONTROL_SERVO_6,INPUT_PULLUP);}
        else{bitSet(analog_servo,5);}EEPROM.write(30,analog_servo);Serial.println(succes);pinMode(CONTROL_SERVO_6,INPUT);}
